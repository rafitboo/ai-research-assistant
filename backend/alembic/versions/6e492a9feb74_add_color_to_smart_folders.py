"""Add color to smart folders

Revision ID: 6e492a9feb74
Revises: 70ac2ef8f1c1
Create Date: 2026-08-18 00:02:59.000252
...
revision: str = '6e492a9feb74'
down_revision: Union[str, Sequence[str], None] = '70ac2ef8f1c1'
...
def upgrade() -> None:
    ...
    op.add_column('smart_folders', sa.Column('color', sa.String(), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('smart_folders', 'color')
